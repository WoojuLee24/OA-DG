    ...
    def evaluate(self,
        ...
        if len(metrics) > 0:
            ...
            self_coco = CocoDataset(self.ann_file, self.pipeline.transforms,
                                    ...
                                    self.test_mode, self.filter_empty_gt, picked_label=picked_label)
            # TODO: remove this in the future
            # reload annotations of correct class
            self_coco.CLASSES = self.CLASSES
            self_coco.data_infos = self_coco.load_annotations(self_coco.ann_file) # self_coco.data_infos = self_coco.load_annotations(self.ann_file)
            eval_results.update(
