...
from mmdet.core.evaluation.class_names import sdgod_classes

label_ids = {name: i for i, name in enumerate(sdgod_classes())}
...
def cvt_to_coco_json(annotations):
    ...
    for category_id, name in enumerate(sdgod_classes()):
        category_item = dict()
